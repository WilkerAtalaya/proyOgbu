    ...
    <div class="contenido-modal">
      ...
      <div v-if="solicitud.archivo" class="mb-4">
        ...
        <v-card class="imagen-container">
          <v-img :src="getImageUrl(solicitud.archivo)" :alt="solicitud.titulo" cover style="border-radius: 8px;"
            height="200">
      ...
      <div class="mb-4">
        <label style="font-size: 18px; color: black; font-weight: 400; margin-bottom: 8px; display: block;">Stock
          Solicitado</label>
        <div class="info-field">
